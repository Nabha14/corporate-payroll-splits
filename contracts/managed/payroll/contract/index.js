...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.salaryAmount) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named salaryAmount');
    }
    if (typeof(witnesses_0.salarySalt) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named salarySalt');
    }
    this.witnesses = witnesses_0;
    this.circuits = {
      registerEmployeeSalary: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`registerEmployeeSalary: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const employee_pk_0 = args_1[1];
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(employee_pk_0).concat(_descriptor_0.toValue(commitment_0)),
        ...
        const result_0 = this._registerEmployeeSalary_0(context,
                                                        partialProofData,
                                                        employee_pk_0,
                                                        commitment_0);
      ...
      claimSalary: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`claimSalary: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
        ...
        const result_0 = this._claimSalary_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      },
    ...
    this.impureCircuits = {
      registerEmployeeSalary: this.circuits.registerEmployeeSalary,
      claimSalary: this.circuits.claimSalary
    };
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('registerEmployeeSalary', new __compactRuntime.ContractOperation());
    state_0.setOperation('claimSalary', new __compactRuntime.ContractOperation());
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_9.toValue(0n),
                                                                                              alignment: _descriptor_9.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(budget_0),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
  ...
  _salaryAmount_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.salaryAmount(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
  ...
  _salarySalt_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.salarySalt(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
  ...
  _registerEmployeeSalary_0(context,
                            partialProofData,
                            employee_pk_0,
                            commitment_0)
  {
  ...
  _claimSalary_0(context, partialProofData) {
    ...
    __compactRuntime.assert(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      ...
                                                                                      [
                                                                                       ...
                                                                                       { popeq: { cached: true,
                                                                                                  result: undefined } }]).value),
                            'No salary record found for employee');
...
const _dummyContract = new Contract({
  ...
  salaryAmount: (...args) => undefined,
  salarySalt: (...args) => undefined
});
export const pureCircuits = {
  computeCommitment: (...args_0) => {
    ...
    return _dummyContract._computeCommitment_0(amount_0, salt_0, sk_0);
  },
  publicKey: (...args_0) => {
    if (args_0.length !== 1) {
